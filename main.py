    ...
    def SetImage(self):
        if(size > self.indx):
            ...
            if self.verticalSpacer != None:
                self.mainLayout.removeItem(self.verticalSpacer)
            label = QLabel()
            label.setText("Input field exceed max. size.")
...
class MyForm(QDialog):
    def __init__(self, parent=None):
        ...
        self.ui.b_output_volume_sei_change.clicked.connect(self.change_lto_mode_sei)
        self.ui.b_output_volume_huku_change.clicked.connect(self.change_lto_mode_huku)
        ...
        self.ui.cb_input_volume_change_time.stateChanged.connect(self.input_volume_change_time_settings)
        ...
        self.l_input_volumes = [self.ui.l_input_volume_2,self.ui.l_input_volume_3,self.ui.l_input_volume_4,self.ui.l_input_volume_5,self.ui.l_input_volume_6,self.ui.l_input_volume_7,self.ui.l_input_volume_8,self.ui.l_input_volume_9,self.ui.l_input_volume_10,self.ui.l_input_volume_11,
                                self.ui.l_input_volume_12,self.ui.l_input_volume_13,self.ui.l_input_volume_14,self.ui.l_input_volume_15,self.ui.l_input_volume_16,self.ui.l_input_volume_17,self.ui.l_input_volume_18,self.ui.l_input_volume_19,self.ui.l_input_volume_20,self.ui.l_input_volume_21,
                                self.ui.l_input_volume_22,self.ui.l_input_volume_23,self.ui.l_input_volume_24,self.ui.l_input_volume_25,self.ui.l_input_volume_26,self.ui.l_input_volume_27,self.ui.l_input_volume_28,self.ui.l_input_volume_29,self.ui.l_input_volume_30,self.ui.l_input_volume_31,
                                self.ui.l_input_volume_32,self.ui.l_input_volume_33,self.ui.l_input_volume_34,self.ui.l_input_volume_35,self.ui.l_input_volume_36,self.ui.l_input_volume_37,self.ui.l_input_volume_38,self.ui.l_input_volume_39,self.ui.l_input_volume_40,self.ui.l_input_volume_41,
                                self.ui.l_input_volume_42,self.ui.l_input_volume_43,self.ui.l_input_volume_44,self.ui.l_input_volume_45,self.ui.l_input_volume_46,self.ui.l_input_volume_47,self.ui.l_input_volume_48,self.ui.l_input_volume_49,self.ui.l_input_volume_50]
        self.cb_ins = [self.ui.cb_in_2,self.ui.cb_in_3,self.ui.cb_in_4,self.ui.cb_in_5,self.ui.cb_in_6,self.ui.cb_in_7,self.ui.cb_in_8,self.ui.cb_in_9,self.ui.cb_in_10,self.ui.cb_in_11,
                    self.ui.cb_in_12,self.ui.cb_in_13,self.ui.cb_in_14,self.ui.cb_in_15,self.ui.cb_in_16,self.ui.cb_in_17,self.ui.cb_in_18,self.ui.cb_in_19,self.ui.cb_in_20,self.ui.cb_in_21,
                    self.ui.cb_in_22,self.ui.cb_in_23,self.ui.cb_in_24,self.ui.cb_in_25,self.ui.cb_in_26,self.ui.cb_in_27,self.ui.cb_in_28,self.ui.cb_in_29,self.ui.cb_in_30,self.ui.cb_in_31,
                    self.ui.cb_in_32,self.ui.cb_in_33,self.ui.cb_in_34,self.ui.cb_in_35,self.ui.cb_in_36,self.ui.cb_in_37,self.ui.cb_in_38,self.ui.cb_in_39,self.ui.cb_in_40,self.ui.cb_in_41,
                    self.ui.cb_in_42,self.ui.cb_in_43,self.ui.cb_in_44,self.ui.cb_in_45,self.ui.cb_in_46,self.ui.cb_in_47,self.ui.cb_in_48,self.ui.cb_in_49,self.ui.cb_in_50]
        self.b_input_volumes = [self.ui.b_input_volume_2,self.ui.b_input_volume_3,self.ui.b_input_volume_4,self.ui.b_input_volume_5,self.ui.b_input_volume_6,self.ui.b_input_volume_7,self.ui.b_input_volume_8,self.ui.b_input_volume_9,self.ui.b_input_volume_10,self.ui.b_input_volume_11,
                                self.ui.b_input_volume_12,self.ui.b_input_volume_13,self.ui.b_input_volume_14,self.ui.b_input_volume_15,self.ui.b_input_volume_16,self.ui.b_input_volume_17,self.ui.b_input_volume_18,self.ui.b_input_volume_19,self.ui.b_input_volume_20,self.ui.b_input_volume_21,
                                self.ui.b_input_volume_22,self.ui.b_input_volume_23,self.ui.b_input_volume_24,self.ui.b_input_volume_25,self.ui.b_input_volume_26,self.ui.b_input_volume_27,self.ui.b_input_volume_28,self.ui.b_input_volume_29,self.ui.b_input_volume_30,self.ui.b_input_volume_31,
                                self.ui.b_input_volume_32,self.ui.b_input_volume_33,self.ui.b_input_volume_34,self.ui.b_input_volume_35,self.ui.b_input_volume_36,self.ui.b_input_volume_37,self.ui.b_input_volume_38,self.ui.b_input_volume_39,self.ui.b_input_volume_40,self.ui.b_input_volume_41,
                                self.ui.b_input_volume_42,self.ui.b_input_volume_43,self.ui.b_input_volume_44,self.ui.b_input_volume_45,self.ui.b_input_volume_46,self.ui.b_input_volume_47,self.ui.b_input_volume_48,self.ui.b_input_volume_49,self.ui.b_input_volume_50]

        for i in range(len(self.cb_ins)):
            self.cb_ins[i].stateChanged.connect(self.input_volumes_setting_cb)
            self.b_input_volumes[i].clicked.connect(self.input_volumes_setting_b)
        ...
        self.ui.cb_same_time_mode.stateChanged.connect(self.cb_same_time_mode_settings)
    ...
    def output_volume_setting_sei(self):
        ...
        if(dir_path):
            ...
            self.textBrowser_output('[EVENT]LTO(primary) set to: ' + dir_path + ".")
    ...
    def output_volume_setting_huku(self):
        ...
        if(dir_path):
            ...
            self.textBrowser_output('[EVENT]LTO(duplicate) set to: ' + dir_path + ".")
    ...
    def input_volume_setting(self):
        ...
        if(dir_path):
            ...
            self.textBrowser_output('[EVENT]Input folder set to: ' + dir_path + ".")
            self.change_dsn()
    ...
    def output_volume_setting(self):
        ...
        if(dir_path):
            ...
            self.textBrowser_output('[EVENT]Output folder set to: ' + dir_path + ".")
            self.change_dsn()

    def output_volume_setting_reset(self):
        self.ui.l_output_volume.setText("not selected")
        self.textBrowser_output('[EVENT]Unset output folder.')
    ...
    def tmp_volume_setting(self):
        ...
        if(dir_path):
            ...
            self.textBrowser_output('[EVENT]tmp folder set to: ' + dir_path + ".")
            
            self.change_dsn()

    def tmp_volume_setting_reset(self):
        self.ui.l_tmp_volume.setText("not selected")
        self.textBrowser_output('[EVENT]Unset tmp foler.')
        self.change_dsn()


    def input_volumes_setting_cb(self):
        for i in range(len(self.cb_ins)):
            if(self.cb_ins[i].checkState() != 0):
                self.b_input_volumes[i].setDisabled(False)
                if((i + 1 ) < len(self.cb_ins)):
                    self.cb_ins[i + 1].setDisabled(False)
                self.input_volume_extra_max_num = i + 2
            else:
                self.l_input_volumes[i].setText("not selected")
                self.b_input_volumes[i].setDisabled(True)
                for j in range(i + 1,len(self.cb_ins)):
                    self.cb_ins[j].setChecked(False)
                    self.cb_ins[j].setDisabled(True)
                    self.l_input_volumes[j].setText("not selected")
                    self.b_input_volumes[j].setDisabled(True)
                
    def input_volumes_setting_b(self):
        sender = self.sender()
        dir_path = None
        for i in range(len(self.b_input_volumes)):
            if sender is self.b_input_volumes[i]:
                ...
                if(dir_path):
                    self.l_input_volumes[i].setText(dir_path)
                    self.textBrowser_output('[EVENT]Input Volume Extra(' + str(i + 2)+') set to: ' + dir_path + " .")
                    self.change_dsn()
        
    def input_volume_change_time_settings(self):
        if(self.ui.cb_input_volume_change_time.isChecked()):
            self.ui.timeEdit.setDisabled(False)
        else:
    ...
    def keysmith_setting_input(self):
        ...
        if (fname[0]!= ""):#ファイルを読み込めたら
            try:
                ...
                self.ui.l_keysmith_limit_message.setText('Config loaded')
            except:
                self.ui.l_keysmith_limit_message.setText('Keysmith config not found')

    def cb_same_time_mode_settings(self):
        if(self.ui.cb_same_time_mode.isChecked()):
            self.change_dsn()
            self.ui.timeEdit.setDisabled(False)
            self.ui.cb_input_volume_change_time.setDisabled(False)
            self.ui.cb_input_volume_change_time.setChecked(False)
        else:
            self.change_dsn()
            self.ui.timeEdit.setDisabled(True)
            self.ui.cb_input_volume_change_time.setDisabled(True)
            self.ui.cb_input_volume_change_time.setChecked(False)
    ...
    def keysmith_setting_output(self):
        ...
        if(self.innerWidget1.LneEdts[0].text() == "") or (self.innerWidget2.LneEdts[0].text() == ""):            
            self.ui.l_keysmith_limit_message.setText('Keysmith URL1 or 2 not found')
        elif(len(self.innerWidget1.LneEdts) != len(self.innerWidget2.LneEdts)):
            self.ui.l_keysmith_limit_message.setText('No. of macros in Keysmith URL1 or 2 confilicts.')
        else:
            ...
            self.textBrowser_output('[EVENT]Keysmith config file exported')
            self.textBrowser_output('   [INFO]at' + fileName + ' . ')
            self.ui.l_keysmith_limit_message.setText('Exported：keysmith_url' + now.strftime('%Y%m%d_%H%M') + '.ini')
    ...
    def stop_loop(self):
        ...
        self.execAction.stop_flag = True
        self.textBrowser_output('[STOP MODE START]Aborting...')
        ...
        self.textBrowser_output('[STOP MODE END]Aborted.')
    ...
    def rb_animation(self):
        ...
        if radioBtn.isChecked():
            ...
            if(self.rb_animation_opt == "Yes (Append every)"):
                self.textBrowser_output('[EVENT]Amimation will be output every ' + self.rb_animation_opt + "(" + str(self.ui.sp_animation_num.value()) + " slices).")
                self.ui.sp_animation_num.setDisabled(False)
                self.ui.cb_write_animation.setDisabled(False)
                self.ui.cb_write_animation_2.setDisabled(False)
            elif(self.rb_animation_opt == "No"):
                ...
                self.textBrowser_output('[EVENT]Amimation output set to: ' + self.rb_animation_opt + ".")
            else:
                self.ui.sp_animation_num.setDisabled(True)
                self.ui.cb_write_animation.setDisabled(False)
                self.ui.cb_write_animation_2.setDisabled(False)
    ...
    def rb_lto(self):
        ...
        if radioBtn.isChecked():
            ...
            self.textBrowser_output('[EVENT]LTO output: ' + self.rb_lto_opt + " ")
            self.ui.b_output_volume_sei.setDisabled(False)
            self.ui.b_output_volume_huku.setDisabled(False)

            if(self.rb_lto_opt == "Primary only"):
                self.ui.l_output_volume_huku.setText("set to primary only")
                ...
                if(self.ui.l_output_volume_sei.text() == "Set to no LTO archive "):
                    self.ui.l_output_volume_sei.setText("not selected")

            elif(self.rb_lto_opt == "No"):
                self.ui.l_output_volume_sei.setText("Set to no LTO archive")
                self.ui.b_output_volume_sei.setDisabled(True)
                self.ui.l_output_volume_huku.setText("Set to no LTO archive")
                self.ui.b_output_volume_huku.setDisabled(True)
                ...
                if(self.ui.l_output_volume_sei.text() == "Set to no LTO archive"):
                    self.ui.l_output_volume_sei.setText("not selected")
                if(self.ui.l_output_volume_huku.text() == "Set to no LTO archive") or (self.ui.l_output_volume_huku.text() == "set to primary only"):
                    self.ui.l_output_volume_huku.setText("not selected")
    ...
    def change_lto_mode_sei(self):
        self.ui.l_output_volume_sei.setText("OK")
        
    def change_lto_mode_huku(self):
        self.ui.l_output_volume_huku.setText("OK")


    def sp_animation(self):
        self.textBrowser_output('[EVENT]Animation output every' + self.rb_animation_opt + "(" + str(self.ui.sp_animation_num.value()) + ") images")
    ...
    def contents_disable(self):
        ...
        #保存設定に関する情報
        for i in range(len(self.cb_ins)):
            self.cb_ins[i].setEnabled(False)
            self.b_input_volumes[i].setEnabled(False)

        self.ui.cb_input_volume_change_time.setEnabled(False)
    ...
    def change_temperature(self):
        ...
        for i in range(4):
            if(all(val == l[i][0] for val in l[i])):
                self.temperatures.append(l[i][0])
            else:
                dist = [s for s in l[i] if s != '']
                self.temperatures.append(dist[0])
    ...
    def light_source(self):
        ...
        for i in range(len(lights)):
            for j in range(len(lights[i])):
                if(len(lights[i]) >= 2):
                    lights_2.append([s for s in lights[i] if s != ''])
                    break
                else:
                    lights_2.append(lights[i])
                    
        lights_2 = list(itertools.chain.from_iterable(lights_2))
        
        if(len(lights_2)> 4):
            self.textBrowser_output("[ERROR]Light should be less than 5 types")
            self.textBrowser_output("   [INFO]" + '・'.join(lights_2))
            return False
    ...
    def request_check(self):
        ...
        if(self.ui.l_tmp_volume.text() != "not selected"):
            ...
            for i_size in range(1,size):
                dist_path = os.path.join(self.ui.l_tmp_volume.text() + '/tmp'+str(i_size))
                try:
                    os.mkdir(dist_path)
                    self.textBrowser_output('   [INFO]Folder created: ' + dist_path + ' ')
                except:
                    self.textBrowser_output('   [INFO]Folder already exists: ' + dist_path + ' ')

        elif(self.ui.l_output_volume.text() == "not selected") and (self.ui.l_tmp_volume.text() == "not selected"):
            try:
        ...
        if(self.ui.l_output_volume.text() == "not selected"):
            try:
                ...
                self.textBrowser_output('   [INFO]Folder already exists: ' + dist_path + ' ')
            reply = QMessageBox.question(self, 'Viewer app check', 'Launch viewer app at each mac mimi and select ' + self.ui.l_input_volume.text() + '/tmp1~' +str(size-1) +' .',
            ...
            try:
                ...
                self.textBrowser_output('   [INFO]Folder already exists: ' + dist_path + ' ')
            reply = QMessageBox.question(self, 'Viewer app check', 'Launch viewer app at each mac mimi and select ' + self.ui.l_output_volume.text() + '/tmp1~' +str(size-1) +'.',
                QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
        
        self.textBrowser_output('[MKDIR MODE END]')
        self.textBrowser_output('------------------------------------------')
    ...
    def default_settings(self):
        ...
        #アプリ起動時のラジオボタン初期値
        self.rb_sample_type = 'Geology and Paleontology'
        self.name = "Taxon and/or lithology"
        self.rb_selected_dataset = 'No'
        self.rb_selected_voxel = 'No'
        self.rb_selected_related_samples = 'No'
        self.rb_selected_presence_active = 'Yes'
        self.rb_selected_stlle_plate_active = 'Yes'
        self.rb_selected_network = 'LAN'
        self.rb_camera_direction = 'Horizontal'

        self.grinding_tools = 'Grinding cup wheel'
        self.select_filters = []
        self.light_pares = []
        ...
        self.rb_animation_opt = "Yes (All at once)"
        self.rb_lto_opt = "Primary only"
        
        self.rb_full_opt = "FullSet"
        

        #アプリ起動時の試料情報表
        self.ui.l_taxon_lithology.setText('Rock/fossil name')
        ...
        self.ui.rb_rb_nokosu_opt = "Keep"

        self.input_volume_extra_max_num = 0
        self.ui.cb_input_volume_change_time.setChecked(False)
        self.ui.cb_input_volume_change_time.setDisabled(True)
        self.ui.timeEdit.setDisabled(True)

        for i in range(1,len(self.cb_ins)):
            self.cb_ins[i].setDisabled(True)
    ...
    def log_output(self):
        ...
        self.textBrowser_output('    [INFO]LAB BOOK SAVED')
        self.textBrowser_output('[LAB BOOK MODE END]')
        self.textBrowser_output('------------------------------------------')
        if(self.ui.cw_log_output.isChecked == True):
            self.chat_message_send('LAB BOOK output：DONE')
    ...
    def log_re_output(self):
        ...
        self.textBrowser_output('------------------------------------------')
        if(self.ui.cw_log_output.isChecked == True):
            self.chat_message_send('LAB BOOK re-output：DONE')
    ...
    def rb_diamond_bite_cliked(self):
        ...
        if(self.grinding_tools == 'Single crystal diamond bite'):
    ...
    def main_action(self):
        ...
        if(self.ui.cw_log_output.isChecked() == True):
            self.chat_message_send('Log output：DONE')
        ...
        self.execAction.stop_flag = False
        self.execAction.input_volume_extra_max_num = self.input_volume_extra_max_num
        self.execAction.l_input_volumes = self.l_input_volumes
        
        self.execAction.cb_ins = self.cb_ins
        self.execAction.input_volumes = [self.ui.l_input_volume,self.ui.l_input_volume_2,self.ui.l_input_volume_3,self.ui.l_input_volume_4,self.ui.l_input_volume_5,self.ui.l_input_volume_6,self.ui.l_input_volume_7,self.ui.l_input_volume_8,self.ui.l_input_volume_9,self.ui.l_input_volume_10,self.ui.l_input_volume_11,
                                        self.ui.l_input_volume_12,self.ui.l_input_volume_13,self.ui.l_input_volume_14,self.ui.l_input_volume_15,self.ui.l_input_volume_16,self.ui.l_input_volume_17,self.ui.l_input_volume_18,self.ui.l_input_volume_19,self.ui.l_input_volume_20,self.ui.l_input_volume_21,
                                        self.ui.l_input_volume_22,self.ui.l_input_volume_23,self.ui.l_input_volume_24,self.ui.l_input_volume_25,self.ui.l_input_volume_26,self.ui.l_input_volume_27,self.ui.l_input_volume_28,self.ui.l_input_volume_29,self.ui.l_input_volume_30,self.ui.l_input_volume_31,
                                        self.ui.l_input_volume_32,self.ui.l_input_volume_33,self.ui.l_input_volume_34,self.ui.l_input_volume_35,self.ui.l_input_volume_36,self.ui.l_input_volume_37,self.ui.l_input_volume_38,self.ui.l_input_volume_39,self.ui.l_input_volume_40,self.ui.l_input_volume_41,
                                        self.ui.l_input_volume_42,self.ui.l_input_volume_43,self.ui.l_input_volume_44,self.ui.l_input_volume_45,self.ui.l_input_volume_46,self.ui.l_input_volume_47,self.ui.l_input_volume_48,self.ui.l_input_volume_49,self.ui.l_input_volume_50]
        ...
        if(self.rb_lto_opt != "No"):
            self.printLog_sync("[MESSAGE]LTO copy mode")
            self.SyncThread = SyncThread()
            self.SyncThread.ui = self.ui
            self.SyncThread.ARW_NUMBER = ARW_COMBINATION_NUMBER
            self.SyncThread.rb_lto_opt = self.rb_lto_opt   
            self.SyncThread.SAME_TIME_MODE = self.ui.cb_same_time_mode.isChecked()
            self.SyncThread.printThread.connect(self.printLog_sync)
            self.SyncThread.printThread2.connect(self.printLog_sync2)
            self.SyncThread.start()
        else:
            self.printLog_sync("[MESSAGE]LTO is not set. LTO copy mode is disabled.")
    ...
    def rb_clicked(self):
        ...
        if radioBtn.isChecked():
            ...
            self.textBrowser_output('[EVENT]Sample type changed to: ' + self.rb_sample_type + ' ')
            ...
            if(self.rb_sample_type == 'Geology and Paleontology'):
                self.ui.l_taxon_lithology.setText('Rock/fossil name')        
                self.name = "Taxon and/or lithology"
            ...
            elif(self.rb_sample_type == 'Biology'):
                self.ui.l_taxon_lithology.setText('Scientific name')     
                ...
                self.ui.l_taxon_lithology.setText('Sample name')     
    ...
    def rb_dataset_active_clicked(self):
        ...
        if radioBtn.isChecked():
            ...
            if(self.rb_selected_dataset == 'Yes'):
    ...
    def rb_related_samples_clicked(self):
        ...
        if radioBtn.isChecked():
            ...
            if(self.rb_selected_related_samples == 'Yes'):
                self.ui.e_detailed_information.setDisabled(False)
                self.ui.e_depository.setDisabled(False)
                self.ui.e_depository.setText('National Museum of Nature and Science, Japan')
            else:
    ...
    def cb_prepared(self,state):
        ...
        if state == 0:
            ...
            self.ui.comb_details_of_preparation.addItems(["bonding","coating","filling","others"])
            self.ui.comb_details_of_preparation.setEnabled(True)
            self.ui.e_other_preparation.setEnabled(True)

    def stop_button(self):
        self.stop_flag = True
        self.is_true(self.ui.e_total_grinding_thickness.text(),'Total grinding thickenss (mm)')
        self.is_true(self.ui.e_specimen_storage_area.text(),'Deposited at')

        if(self.stop_flag == False):
            self.textBrowser_output('[ERROR!]Empty fields exist. Stop button disabled.')
        else:
            self.textBrowser_output('   [EVENT]Finish button pushed.')
    ...
    def select_other(self):
        ...
        if(str(self.ui.comb_details_of_preparation.currentText()) == 'other'):
    ...
    def exec_button(self):
        ...
        if(self.lane_checker() == False):
            exec_flag = False
            self.textBrowser_output('[ERROR!]Something is wrong with shot list.')
            self.textBrowser_output('   [MESSAGE]Check again Lane No. at Capture preference 1 is consistent with Capture preference 3')
        ...
        if(self.select_filters == []):
            exec_flag = False
            self.textBrowser_output('Filter')
        ...
        if(self.position_checker() == False):
            exec_flag = False
            self.textBrowser_output('Position')
            self.ui.l_filter.setStyleSheet("QLabel { color : red; }")
        
        if(exec_flag == False):
            self.textBrowser_output('[ERROR!]Empty fields exist.')

        if(self.light_source() == False):
            self.textBrowser_output('[ERROR!]Inconsistent light types')
            exec_flag = False


        if(check_input.shooting_list_checker(self) == False):
            self.textBrowser_output('[ERROR!]Empty fields in shot list.')
            exec_flag = False

        if(len(self.innerWidget1.LneEdts) != (size - 1)) or (self.innerWidget1.LneEdts[0].text() == ""):
            self.textBrowser_output('[ERROR!]KM1: No. of macros inconsistent with size.')
            self.textBrowser_output('   [MESSAGE]Check again KM1 config.')
            exec_flag = False

        if(len(self.innerWidget2.LneEdts) != (size - 1)) or (self.innerWidget2.LneEdts[0].text() == ""):
            self.textBrowser_output('[ERROR!]KM2: No. of macros inconsistent with size.')
            self.textBrowser_output('   [MESSAGE]Check again KM2 config.')
            exec_flag = False

        if(self.connect_check() == False):
            self.textBrowser_output('[ERROR!]Connection to ARW output folder failed.')
            self.textBrowser_output('   [MESSAGE]Check again ARW output folder path.')
            exec_flag = False

        if(self.temperatures == []):
            self.textBrowser_output('[ERROR!]Color temperture is not filled.')
            self.textBrowser_output('   [MESSAGE]Check again color temperture of light 1-4.')
            exec_flag = False
        
        elif(len(self.temperatures) > 4):
            self.textBrowser_output('[ERROR!]More than 5 types of color temperture is configured.')
            self.textBrowser_output('   [MESSAGE]Check again color temperture of light 1-4.')
            exec_flag = False
        ...
        for i in range(len(self.cb_ins)):
            if((self.cb_ins[i].checkState() != 0) and (self.l_input_volumes[i].text() == "not selected")):
                self.textBrowser_output('[ERROR!]Empty fileds exist in Input Volume Extra.')
                exec_flag = False

        t = self.ui.timeEdit.time()
        total_second = (t.hour() * 60 * 60 )+ (t.minute() * 60) + t.second()                           
        if (self.ui.cb_input_volume_change_time.isChecked()) and (total_second<60):
            self.textBrowser_output('[ERROR!]input volume switch interval should be more than 1 minute.')
            exec_flag = False

        for i in range(len(self.l_input_volumes)):
            if(self.l_input_volumes[i].text() != "not selected") and (self.ui.cb_same_time_mode.isChecked()) and (self.ui.cb_input_volume_change_time.isChecked() == False):
                self.textBrowser_output('[ERROR!]Switch interval should be set.')
                exec_flag = False

        if(exec_flag == True):
            if(self.request_check() == False):
                self.textBrowser_output('[ERROR!]Launch Viewer app.')
                
                if(self.ui.l_output_volume.text() == "not selected") and (self.ui.l_tmp_volume.text() == "not selected"):
                    self.textBrowser_output('[ERROR!]Select ' + self.ui.l_input_volume.text() + '/tmp' +' ')
                elif(self.ui.l_tmp_volume.text() != "未選択"):
                    self.textBrowser_output('[ERROR!]Select ' + self.ui.l_tmp_volume.text() + '/tmp' +' ')
                else:
                    self.textBrowser_output('[ERROR!]Select ' + self.ui.l_output_volume.text() + '/tmp' +' ')

            else:
                self.main_action()
        else:
            self.textBrowser_output('[ERROR!]Check above message.')

    def connect_check(self):
        if(self.ui.l_output_volume.text() == "not selected") and (self.ui.l_tmp_volume.text() == "not selected"):
            return os.path.isdir(self.ui.l_input_volume.text())
        elif(self.ui.l_tmp_volume.text() != "not selected"):
    ...
    def scale_set_position(self):
        ...
        if radioBtn.isChecked():
            ...
            self.textBrowser_output('[EVENT]Camera position set to ' + self.rb_camera_direction + '.')
    ...
    def scale(self):
        ...
        try:
            ...
            #横置きの場合
            if(self.rb_camera_direction == 'Horizontal'):
                try:
                    cal = average * kakudai
                    cal = Decimal(str(cal))
                    cal = cal.quantize(Decimal('0.001'), rounding=ROUND_HALF_UP)
    ...
    def setting_output(self):
        ...
        if(check_input.default_necessary(self) == False) or (check_input.special_necessary(self,self.rb_sample_type) == False):
            self.textBrowser_output('[ERROR!]Empty fields exist. Output disabled.')
            ...
            for i in range(len(self.cb_ins)):
                config['lane']['e_input_path' + str(i)] =  self.l_input_volumes[i].text()
            ...
            self.textBrowser_output('[EVENT]Output: ' + fileName + ' ')
    ...
    def setting_input(self):
        ...
        try:
            ...
            for i in range(len(self.l_input_volumes)):
                self.l_input_volumes[i].setText(config['lane']['e_input_path' + str(i)])
                if(self.l_input_volumes[i].text() != "not selected"):
                    self.cb_ins[i].setChecked(True)
                    self.cb_ins[i].setDisabled(False)
                else:
                    self.cb_ins[i].setChecked(False)
                    self.cb_ins[i].setDisabled(True)
            ...
            if(config['lane']['cb_crystal_diamond_bite'] == 'Grinding cup wheel'):
                self.ui.rb_grinding_1.setChecked(True)

            if(config['lane']['rb_selected_dataset'] == 'Yes'):
                self.ui.rb_dataset_active.setChecked(True)
            if(config['lane']['rb_selected_voxel'] == 'Yes'):
                self.ui.rb_voxel_active.setChecked(True)
            if(config['lane']['rb_selected_related_samples'] == 'Present'):
                self.ui.rb_related_samples_active.setChecked(True)
            
            if(config['lane']['rb_selected_presence'] == 'Absent'):
                self.ui.rb_presence_disactive.setChecked(True)
            if(config['lane']['rb_selected_stlle_plate'] == 'Absent'):
                self.ui.rb_stlle_plate_disactive.setChecked(True)

            if(config['lane']['sample_type'] == 'Geology and Paleontology'):
                self.ui.rb_rock_sample.setChecked(True)
            elif(config['lane']['sample_type'] == 'Biology'):
            ...
            if("Primary only" in self.ui.l_output_volume_huku.text()):
                self.ui.b_output_volume_huku.setDisabled(True)        
                self.ui.rb_sei.setChecked(True)

            elif("no" in self.ui.l_output_volume_sei.text()):
                self.ui.b_output_volume_sei.setDisabled(True)   
                self.ui.b_output_volume_huku.setDisabled(True)   
                self.ui.rb_seifuku_nashi.setChecked(True)
            else:
                self.ui.rb_seifuku.setChecked(True)
            self.textBrowser_output('[EVENT]ini file loaded.')
    ...
    def chat_message_send(self,message):
        ...
        try:
            ...
            self.textBrowser_output('[ERROR]Chatwork message send error')
    ...
    def remove_test_ARW(self):
        
        self.textBrowser_output('[DELETE MODE START]Deleting test-shot ARW data in input folder')
        file_names = glob.glob(os.path.join(self.ui.l_input_volume.text(),'*.ARW'))
        file_names.sort()

        for file_name in file_names:
            os.remove(file_name)
            self.textBrowser_output('   [INFO]Deleted ' + str(file_name))
        ...
        self.textBrowser_output('[DELETE MODE END]')
        ...
        if(DEBUG_FLAG == True):
            ...
            start_num = 4809
            for i in range(8):
                dist_path_1 = "/Users/ibayasuhiro/share_mini5/DS00180_ARW_TEST/DS00148_PSMS_4/" + "DSC" + str(start_num + i).zfill(5) + ".ARW"
                dist_path_2 = "/Users/ibayasuhiro/share_mini5/DS00180_ARW_TEST/" + "DSC" + str(start_num + i).zfill(5) + ".ARW"
...
if __name__=='__main__':
    ...
    if rank == 0:
        ...
        while True:
            ...
            if(data["arw_basenames"][int(rank - 1)][0] != ""):
                webbrowser.open(data["keysmith_urls_1"][int(rank - 1)])
                time.sleep(5)
                while True:
                    types = ['tif', 'TIF']
                    tif_files = []
                    ...
                    if((tif_files!=[]) and (os.path.getsize(tif_files[0])!=0)):
                        time.sleep(3)
                        shutil.move(tif_files[0],data["tif_names"][rank - 1])
                        webbrowser.open(data["keysmith_urls_2"][rank - 1])
                        time.sleep(2)
                        break
                    elif((data["tif_names"][rank - 1] == "")):
                        break
                    else:
                        time.sleep(1)
                ...
                for i in range(data["ACN"]):
                    dist_nas_path = os.path.join(data["path"] , 'tmp' + str(rank) , data["target_paths"][int(rank - 1)][i])
                    dist_nas_file_name = data["arw_basenames"][int(rank - 1)][i]
